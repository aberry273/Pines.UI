...
export default function (params) {
	return {
        ...
        init() {
            ...
            $watch('playing', (value) => {
                if (value) {
                    ...
                    this.mxMedia_videoControls = true;
                }
            });
        ...
        setValues(params) {
            ...
            this.mxMedia_ogg = params.ogg;
            this.mxMedia_alt = params.alt;
            this.mxMedia_class = params.class;
            this.mxMedia_videoCanPlay = params.canPlay != null 
                ? params.canPlay
                : true;
            this.mxMedia_videoControls = params.controls != null 
                ? params.controls
                : true;
        },
        timelineSeek(e) {
        ...
        togglePlay(e) {
            if (!this.mxMedia_videoCanPlay) return;
        ...
        mousemoveVideo() {
            if(this.playing){
                ...
                if (!this.mxMedia_videoControls) return;
                this.mxMedia_videoControls=true;
        ...
        render() {
            const html = ` 
                <div x-ref="videoContainer"
                    @mouseleave="mouseleave=true" 
                    @mousemove="mousemoveVideo"
                    class="relative justify-center text-center overflow-hidden rounded-md aspect-video">
                    <video 
                        x-ref="player"
                    ...
                    <div x-show="videoPlayerReady" class="absolute inset-0 w-full h-full">
                        ...
                        <div x-show="mxMedia_videoControls"
